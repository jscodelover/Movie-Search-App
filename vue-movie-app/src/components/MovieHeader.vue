	...
	<div class="movie__header" :style="styles">
		...
		<div class="movie__header--content">
			<h1>
				...
				<span class="text-2xl tracking-wider text-gray-400">
					({{ release_year }})</span
				>
			</h1>
	...
	computed: {
		...
		poster() {
			return this.movieData.backdrop_path
				? `${CONFIG.IMAGE_MD}${this.movieData.backdrop_path}`
				: '../assets/image.png';
		},
		styles() {
			return {
				backgroundImage: `url(${CONFIG.IMAGE_LG}${this.movieData.poster_path})`
			};
		}
	}
};
